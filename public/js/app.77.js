...
Component.options.__file = "resources/assets/js/pages/advocates/Index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-43967184", Component.options)
  } else {
    hotAPI.reload("data-v-43967184", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapActions */])('advocates', ['destroy', 'fetch', 'setCurrentFilter']), {
        confirmDelete: function confirmDelete(id) {
            var _this = this;

            var name = this.byId(id).full_name;
            var c = confirm('Are you sure that you want to delete the advocate, ' + name + '?');
  ...
  return _c("div", [
    _c("header", { staticClass: "content-header" }, [
      _c(
        ...
        [
          _c("add-button", {
            attrs: { url: "/advocates/add", text: "Add Advocate" }
          })
        ],
        1
      ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-43967184", module.exports)
  }
}
