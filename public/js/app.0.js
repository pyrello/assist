...
Component.options.__file = "resources/assets/js/components/controls/Flatpickr.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-56e3d994", Component.options)
  } else {
    hotAPI.reload("data-v-56e3d994", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_flatpickr__ = __webpack_require__(608);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vuelidate_lib_validators__ = __webpack_require__(496);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        __WEBPACK_IMPORTED_MODULE_1_flatpickr___default()(this.$refs.date, this.buildConfig());
    },
    ...
    watch: {
        value: function value(_value) {
            ...
            if (_value) {
                this.$refs.date._flatpickr.setDate(_value);
            }
        },
    ...
    methods: {
        buildConfig: function buildConfig() {
            ...
            var config = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, this.defaultConfig(), this.config);

            config.onChange = function (selectedDates, dateStr, instance) {
                // console.log('Date is changing', selectedDates, dateStr, instance)
                if (selectedDates.length) {
                    var selected = instance.parseDate(dateStr, instance.config.dateFormat);
                    _this.select(instance.formatDate(selected, instance.config.dateFormat));
                } /*else {
                    this.select('')
                  }*/
            };
        ...
        defaultDate: function defaultDate() {
            return __WEBPACK_IMPORTED_MODULE_2_moment___default()().format('YYYY-MM-DD HH:mm:ss');
        },
...
var render = function() {
  ...
  return _c("div", { staticClass: "has-feedback" }, [
    _c("input", {
      ref: "date",
      staticClass: "flatpickr form-control",
      attrs: { type: "text", id: _vm.id, "aria-describedby": "calendarIcon" },
    ...
    _vm._v(" "),
    _c("span", { staticClass: "sr-only", attrs: { id: "calendarIcon" } }, [
      _vm._v("(calendar)")
    ])
  ])
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-56e3d994", module.exports)
  }
}
