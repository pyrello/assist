...
Component.options.__file = "resources/assets/js/pages/clients/notes/Index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-476d7660", Component.options)
  } else {
    hotAPI.reload("data-v-476d7660", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapActions */])('notes', ['destroy', 'fetch']), {
                  ...
                  fn: function(props) {
                    return [
                      _c(
                        ...
                        [
                          _vm._v(
                            _vm._s(_vm._f("truncate")(props.item.content, "50"))
                          )
                        ]
                      )
                    ]
                              ...
                              ? _c(
                                  "router-link",
                                  {
                                    attrs: {
                                      to:
                                        "/" +
                                        props.item.path_fragment +
                                        "/" +
                                        props.item.noteable_id
                                    }
                                  },
                  ...
                  fn: function(props) {
                    return [
                      _vm._v(
                        "\n                " +
                          _vm._s(
                            _vm._f("prettyDatetime")(props.item.created_at)
                          ) +
                          "\n            "
                      )
                    ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-476d7660", module.exports)
  }
}
