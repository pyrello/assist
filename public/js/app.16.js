...
Component.options.__file = "resources/assets/js/pages/clients/notes/Add.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0546769f", Component.options)
  } else {
    hotAPI.reload("data-v-0546769f", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__models_Note__ = __webpack_require__(557);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            note: new __WEBPACK_IMPORTED_MODULE_9__models_Note__["a" /* default */]()
        };
    },
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["b" /* mapActions */])('notes', ['create']), {
        init: function init() {
            this.setAuthUser();
        ...
        process: function process() {
            ...
            if (!this.$v.$invalid) {
                ...
                this.create(config).then(function (created) {
                    _this.addMessage('Added note for ' + _this.client.full_name);
                    _this.$router.push('/clients/' + _this.client.id + '/notes');
                }).catch(function (error) {
        ...
        resetData: function resetData() {
            this.note = new __WEBPACK_IMPORTED_MODULE_9__models_Note__["a" /* default */]();
        },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0546769f", module.exports)
  }
}
