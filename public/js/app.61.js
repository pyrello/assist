...
Component.options.__file = "resources/assets/js/components/controls/selects/Clients.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a53d2de4", Component.options)
  } else {
    hotAPI.reload("data-v-a53d2de4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapActions */])('clientAutocomplete', ['clear', 'fetch']), {
        defaultConfig: function defaultConfig() {
            var that = this;
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.preload, function(item) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-a53d2de4", module.exports)
  }
}
