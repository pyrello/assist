...
Component.options.__file = "resources/assets/js/pages/clients/outcomes/Show.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1746cd77", Component.options)
  } else {
    hotAPI.reload("data-v-1746cd77", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_notes_List_vue__ = __webpack_require__(404);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_notes_List_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_notes_List_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mixins_initClient__ = __webpack_require__(495);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixins_initClientOutcome__ = __webpack_require__(591);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_2__mixins_initClient__["a" /* default */], __WEBPACK_IMPORTED_MODULE_3__mixins_initClientOutcome__["a" /* default */]],

    components: {
        Notes: __WEBPACK_IMPORTED_MODULE_1__components_notes_List_vue___default.a
    },
    ...
    methods: {
        confirmDelete: function confirmDelete() {
            ...
            var c = confirm('Are you sure that you want to delete this note?');

            if (c) {
                this.destroy({ id: this.outcome.id }).then(function () {
                    _this.addMessage('Note has been deleted.');
                });
            }
        },
        init: function init() {
    ...
    _vm.outcome
      ? _c("div", [
            ...
            _c(
              ...
              [
                ...
                _vm.client
                  ...
                  : _vm._e(),
                _vm._v(" on " + _vm._s(_vm._f("prettyDate")(_vm.outcome.date)))
              ],
              2
            ),
            _vm._v(" "),
          ...
          _c(
            ...
            { staticClass: "section" },
            [
              _vm.outcome.advocate
                ? _c("p", [
                    _vm._v(
                      "Advocate: " + _vm._s(_vm.outcome.advocate.full_name)
                    )
                  ])
                : _vm._e(),
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(_vm.outcome.description))]),
              _vm._v(" "),
              _c("notes", {
                attrs: {
                  params: _vm.noteParams,
                  client_id: _vm.client.id,
                  noteable_id: _vm.outcome.id,
                  noteable_type: _vm.outcome.noteable_type
                }
              })
            ],
            1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1746cd77", module.exports)
  }
}
