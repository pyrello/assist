webpackJsonp([13,3,29,57,59,63,93],{
...
Component.options.__file = "resources/assets/js/components/forms/DependentFormPartial.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-17392c16", Component.options)
  } else {
    hotAPI.reload("data-v-17392c16", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "resources/assets/js/pages/clients/dependents/Add.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1519e7ec", Component.options)
  } else {
    hotAPI.reload("data-v-1519e7ec", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_Dependent__ = __webpack_require__(531);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__controls_selects_Ethnicity__ = __webpack_require__(398);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__controls_selects_Ethnicity___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__controls_selects_Ethnicity__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__controls_selects_Genders__ = __webpack_require__(399);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__controls_selects_Genders___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__controls_selects_Genders__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        ...
        SelectEthnicity: __WEBPACK_IMPORTED_MODULE_3__controls_selects_Ethnicity___default.a,
        SelectGender: __WEBPACK_IMPORTED_MODULE_4__controls_selects_Genders___default.a
    },
    ...
    data: function data() {
        return {
            model: new __WEBPACK_IMPORTED_MODULE_2__models_Dependent__["a" /* default */]()
        };
    },


    computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapGetters */])('housingStatuses', {
        housingStatuses: 'all'
    })),
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "div",
      { staticClass: "form-group", class: _vm.controlClasses("name") },
      [
        _c(
          "label",
          { staticClass: "control-label" },
          [_vm._v("Name "), _c("required-asterisk")],
          1
        ),
        _vm._v(" "),
        _c("input", {
    ...
    _c(
      ...
      [
        ...
        _c("small", { staticClass: "help-block" }, [
          _vm._v(
            "For dependents with multiple ethnicity, please select them in the order that the client identifies them."
          )
        ])
      ],
      1
    ...
    _c(
      ...
      {
        staticClass: "form-group",
        class: _vm.controlClasses("housing_status")
      },
      [
        _c(
          "label",
          { staticClass: "control-label", attrs: { for: "housing_status" } },
          [_vm._v("Housing Status")]
        ),
        _vm._v(" "),
        _c("selectize", {
          attrs: { all: _vm.housingStatuses },
          model: {
            value: _vm.model.housing_status,
            callback: function($$v) {
              _vm.$set(_vm.model, "housing_status", $$v)
            },
            expression: "model.housing_status"
          }
        })
      ],
      1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-17392c16", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_forms_DependentFormPartial__ = __webpack_require__(412);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_forms_DependentFormPartial___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_forms_DependentFormPartial__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_RequiredAsterisk_vue__ = __webpack_require__(397);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_RequiredAsterisk_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__components_RequiredAsterisk_vue__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__models_Dependent__ = __webpack_require__(531);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        DependentFormPartial: __WEBPACK_IMPORTED_MODULE_6__components_forms_DependentFormPartial___default.a,
        RequiredAsterisk: __WEBPACK_IMPORTED_MODULE_7__components_RequiredAsterisk_vue___default.a,
    ...
    data: function data() {
        return {
            dependent: new __WEBPACK_IMPORTED_MODULE_11__models_Dependent__["a" /* default */]()
        };
    },
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_3_vuex__["b" /* mapActions */])('dependents', ['create']), {
        init: function init() {
        ...
        process: function process() {
            ...
            if (!this.$v.$invalid) {
                ...
                this.create(config).then(function (created) {
                    _this.addMessage('Added ' + created.name + ' as a dependent for ' + _this.client.full_name);
                    _this.$router.push('/clients/' + _this.client.id + '/dependents');
                }).catch(function (error) {
        ...
        resetData: function resetData() {
            this.dependent = new __WEBPACK_IMPORTED_MODULE_11__models_Dependent__["a" /* default */]();
        },
      ...
      _c("div", { staticClass: "section" }, [
        _c(
          ...
          [
            _vm._m(0),
            _vm._v(
              " This form is only for adding a non-client dependent. If you need to add a "
            ),
            _c("em", [_vm._v("dependent who is also a client")]),
            _vm._v(", please "),
            _c("router-link", { attrs: { to: "/intake" } }, [
              _vm._v("start an intake")
            ]),
            _vm._v(" and select "),
            _c("client-link", { attrs: { client: _vm.client } }),
            _vm._v(" as the parent/guardian.")
          ],
          1
        ),
        _vm._v(" "),
        _c(
          ...
          [
            _c(
              ...
              [
                ...
                _c("select-advocate", {
                  on: {
                    input: function($event) {
                      return _vm.$v.dependent.advocate_id.$touch()
                    }
                  },
                  model: {
                    value: _vm.dependent.advocate_id,
                    callback: function($$v) {
                      _vm.$set(_vm.dependent, "advocate_id", $$v)
                    },
                    expression: "dependent.advocate_id"
                  }
                })
              ],
              1
            ...
            _vm._v(" "),
            _c("dependent-form-partial", {
              attrs: { $v: _vm.$v.dependent },
              model: {
                value: _vm.dependent,
                callback: function($$v) {
                  _vm.dependent = $$v
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1519e7ec", module.exports)
  }
}
