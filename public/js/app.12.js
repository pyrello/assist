webpackJsonp([12,3,28,54,62,63,93],{
...
Component.options.__file = "resources/assets/js/pages/clients/incidents/Add.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9a98d882", Component.options)
  } else {
    hotAPI.reload("data-v-9a98d882", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__mixins_localities__ = __webpack_require__(517);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__mixins_validationClasses__ = __webpack_require__(492);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__models_Incident__ = __webpack_require__(523);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_8__mixins_initClient__["a" /* default */], __WEBPACK_IMPORTED_MODULE_9__mixins_localities__["a" /* default */], __WEBPACK_IMPORTED_MODULE_10__mixins_validationClasses__["a" /* default */]],

    // Data
    data: function data() {
        return {
            incident: new __WEBPACK_IMPORTED_MODULE_11__models_Incident__["a" /* default */]()
        };
    },
    ...
    validations: {
        incident: {
            ...
            incident_type_id: {
                minValue: Object(__WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["minValue"])(1),
                numeric: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["numeric"],
                required: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["required"]
            },
            date: {
    ...
    // Watchers
    watch: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()({
        authUser: function authUser() {
            this.setAuthUser();
        },
        client: function client() {
            console.warn('watch@client');
            if (Object(__WEBPACK_IMPORTED_MODULE_4__common__["f" /* defined */])(this.client)) {
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_3_vuex__["b" /* mapActions */])('incidents', ['create']), {
        init: function init() {
        ...
        process: function process() {
            ...
            if (!this.$v.$invalid) {
                ...
                this.create(config).then(function (created) {
                    _this.addMessage('Added ' + created.type.name + ' incident for ' + _this.client.full_name);
                    _this.fetchCurrentClient();
                    _this.$router.push('/clients/' + _this.client.id + '/incidents');
                }).catch(function (error) {
        ...
        resetData: function resetData() {
            this.incident = new __WEBPACK_IMPORTED_MODULE_11__models_Incident__["a" /* default */]();
        },
        ...
        _c(
          ...
          [
            _c(
              ...
              {
                staticClass: "form-group",
                class: _vm.controlClasses("advocate_id", "incident")
              },
              [
                _c(
                  "label",
                ...
                _c("select-advocate", {
                  on: {
                    input: function($event) {
                      return _vm.$v.incident.advocate_id.$touch()
                    }
                  },
                  model: {
            ...
            _c(
              "button",
              {
                ...
                attrs: { type: "submit", disabled: _vm.$v.incident.$invalid }
              },
              [_vm._v("Save")]
            ),
            _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9a98d882", module.exports)
  }
}
