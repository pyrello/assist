...
Component.options.__file = "resources/assets/js/pages/incidents/Show.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-43837c68", Component.options)
  } else {
    hotAPI.reload("data-v-43837c68", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__mixins_initIncident__ = __webpack_require__(530);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_notes_List_vue__ = __webpack_require__(404);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_notes_List_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_notes_List_vue__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_4__mixins_initClient__["a" /* default */], __WEBPACK_IMPORTED_MODULE_5__mixins_initIncident__["a" /* default */]],

    components: {
        Notes: __WEBPACK_IMPORTED_MODULE_6__components_notes_List_vue___default.a
    },
    ...
    computed: {
        ...
        incidentClient: function incidentClient() {
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["b" /* mapActions */])('incidents', ['destroy']), {
        confirmDelete: function confirmDelete(id) {
            var _this = this;
            ...
            if (c) {
                var client_id = this.incident.client_id;
                this.destroy({ id: id }).then(function () {
        ...
        currentIncidentFetched: function currentIncidentFetched() {
            var _this2 = this;

            // this.log('currentIncidentFetched')
            this.$nextTick(function () {
                // this.log('incident', this.incidentData)
                var client_id = _this2.incidentData.client_id;
                // this.params.client_id = this.incident.client_id
                _this2.$set(_this2.params, 'client_id', client_id);
                _this2.fetchClient({ id: client_id, fetchId: 'id:' + client_id });
            });
        },
        init: function init() {
    ...
    _vm.incident
      ? _c("div", [
          _c("header", { staticClass: "content-header" }, [
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            attrs: {
                              to: "/incidents/" + _vm.incident.id + "/edit"
                            }
                          },
                          [
                            _c("i", { staticClass: "fas fa-edit fa-fw" }),
            ...
            _c("h1", [
              _vm.incident.type
                ? _c("span", [_vm._v(_vm._s(_vm.incident.type.name))])
                : _vm._e(),
              _vm._v(" on " + _vm._s(_vm._f("prettyDate")(_vm.incident.date)))
            ]),
            _vm._v(" "),
            _c(
              "div",
          ...
          _c(
            ...
            { staticClass: "section" },
            [
              _vm.incident.advocate
                ? _c("p", [
                    _vm._v("\n                Advocate: "),
                    _c("b", [
                      _vm._v(
                        _vm._s(_vm.incident.advocate.first_name) +
                          " " +
                          _vm._s(_vm.incident.advocate.last_name)
                      )
                    ])
                  ])
                : _vm._e(),
              ...
              _c("div", { staticClass: "lead" }, [
                    ...
                    ? _c(
                        ...
                        [
                          _c(
                            "router-link",
                            {
                              attrs: { to: "/clients/" + _vm.incidentClient.id }
                            },
                            [_vm._v(_vm._s(_vm.incidentClient.full_name))]
                          ),
                          _vm.incident.client_age
                            ? [
                                _vm._v(
                                  " (" +
                                    _vm._s(_vm.incident.client_age) +
                                    " at the time)"
                                )
                              ]
                            : _vm._e()
                ...
                _c("p", [
                  _vm._v("\n                    Occurred: "),
                  _c("b", [
                    _vm._v(_vm._s(_vm._f("prettyDate")(_vm.incident.date)))
                  ]),
                  _vm._v("\n                    in "),
                  _c("b", [
                    _vm._v(
                      _vm._s(_vm.incident.city) +
                        ", " +
                        _vm._s(_vm.incident.state)
                    )
                  ]),
                  _vm._v(".\n                ")
                ])
              ...
              _c("notes", {
                attrs: {
                  ...
                  client_id: _vm.incident.client_id,
                  noteable_id: _vm.incident.id,
                  noteable_type: _vm.incident.noteable_type
                }
              })
            ],
            1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-43837c68", module.exports)
  }
}
