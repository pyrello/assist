...
Component.options.__file = "resources/assets/js/pages/clients/phones/Edit.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-13371a20", Component.options)
  } else {
    hotAPI.reload("data-v-13371a20", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__mixins_initPhone__ = __webpack_require__(690);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_6__mixins_initClient__["a" /* default */], __WEBPACK_IMPORTED_MODULE_7__mixins_initPhone__["a" /* default */], __WEBPACK_IMPORTED_MODULE_8__mixins_validationClasses__["a" /* default */]],

    computed: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_3_vuex__["c" /* mapGetters */])('phoneTypes', {
        phoneTypes: 'all'
    })),
    ...
    // Watchers
    watch: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({}, 'params.phone_id', function paramsPhone_id() {
        this.init();
    }),

    methods: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_3_vuex__["b" /* mapActions */])('phones', ['update']), {
        init: function init() {
        ...
        process: function process() {
            ...
            if (!this.$v.$invalid) {
                ...
                this.update(config).then(function (updated) {
                    _this.addMessage('Added phone number for ' + _this.client.full_name);
                    _this.fetchClient({ id: _this.client.id });
                    _this.$router.push('/clients/' + _this.client.id + '/profile');
                }).catch(function (error) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_Phone__ = __webpack_require__(537);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ModelMixin__ = __webpack_require__(488);
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, new __WEBPACK_IMPORTED_MODULE_2__ModelMixin__["a" /* default */]({
    name: 'phone',
    storeName: 'phones',
    model: __WEBPACK_IMPORTED_MODULE_1__models_Phone__["a" /* default */]
})));
  ...
  return _c("div", { staticClass: "overlay-background" }, [
    _c("div", { staticClass: "overlay" }, [
      _c("header", { staticClass: "overlay-header" }, [
        ...
        _vm._v(" "),
        _c("h1", [_vm._v("Edit Phone Number")])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "section" }, [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm.phone.isDirty() && _vm.$v.$invalid
              ? _c("p", [
            ...
            _c(
              "button",
              {
                ...
                attrs: {
                  type: "submit",
                  disabled: !_vm.phone.isDirty() || _vm.$v.$invalid
                }
              },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-13371a20", module.exports)
  }
}
