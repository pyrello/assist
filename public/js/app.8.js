webpackJsonp([8,3,22,54,55,58,62,63,85,93],{
...
Component.options.__file = "resources/assets/js/pages/clients/activities/Add.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-33806cba", Component.options)
  } else {
    hotAPI.reload("data-v-33806cba", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_forms_ServiceRequestFormPartial__ = __webpack_require__(420);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_forms_ServiceRequestFormPartial___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_forms_ServiceRequestFormPartial__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__mixins_initClient__ = __webpack_require__(495);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__mixins_initIncident__ = __webpack_require__(530);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__mixins_localities__ = __webpack_require__(517);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models_Activity__ = __webpack_require__(534);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        ServiceRequestFormPartial: __WEBPACK_IMPORTED_MODULE_4__components_forms_ServiceRequestFormPartial___default.a
    },

    mixins: [__WEBPACK_IMPORTED_MODULE_5__mixins_initClient__["a" /* default */], __WEBPACK_IMPORTED_MODULE_6__mixins_initIncident__["a" /* default */], __WEBPACK_IMPORTED_MODULE_7__mixins_localities__["a" /* default */]],

    data: function data() {
        return {
            activity: new __WEBPACK_IMPORTED_MODULE_8__models_Activity__["a" /* default */]()
        };
    },
    validations: function validations() {
        ...
        return {
            activity: {
                ...
                //                },
                why_not_provided: {
                    requiredIf: Object(__WEBPACK_IMPORTED_MODULE_1_vuelidate_lib_validators__["requiredIf"])(function () {
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["b" /* mapActions */])('activities', ['create']), {
        currentClientFetched: function currentClientFetched() {
            var _this2 = this;

            this.$nextTick(function () {
                if (_this2.client.last_incident_id) {
                    _this2.setIncidentId(_this2.client.last_incident_id);
                    _this2.activity.assign({ incident_id: _this2.client.last_incident_id });
                    _this2.fetchIncident({ id: _this2.client.last_incident_id });
                }
            });
        },
        init: function init() {
            ...
            this.$nextTick(function () {
                _this3.setAuthUser();
                _this3.activity.assign({ client_id: _this3.$route.params.client_id });
            });
        },
        process: function process() {
            ...
            if (!this.$v.$invalid) {
                var data = this.activity.getAttributes();
                ...
                this.create(payload).then(function (created) {
                    _this4.addMessage('Added ' + created.service.name + ' activity record for ' + _this4.client.first_name + ' ' + _this4.client.last_name);
                    _this4.$router.push('/clients/' + _this4.client.id + '/activities');
                }).catch(function (error) {
        ...
        resetData: function resetData() {
            this.activity = new __WEBPACK_IMPORTED_MODULE_8__models_Activity__["a" /* default */]();
        },
        ...
        _c(
          ...
          [
            ...
            _c(
              ...
              {
                staticClass: "form-group",
                class: { "has-success": _vm.activity.note !== "" }
              },
              [
                _c(
                  "label",
                  ...
                  directives: [
                    {
                      ...
                      value: _vm.activity.note,
                      expression: "activity.note",
                      modifiers: { trim: true }
                    }
                  ],
                  staticClass: "form-control",
                  attrs: { id: "note", name: "note" },
                  domProps: { value: _vm.activity.note },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.activity, "note", $event.target.value.trim())
                    },
                    blur: function($event) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-33806cba", module.exports)
  }
}
